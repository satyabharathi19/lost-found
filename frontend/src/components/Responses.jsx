...
const fetchMyResponses = async () => {
  try {
    ...
    console.log('API URL:', `${import.meta.env.VITE_REACT_APP_BACKEND_URL}/api/responses/responder/${user.id}`);
    
    const response = await axios.get(`${import.meta.env.VITE_REACT_APP_BACKEND_URL}/api/responses/responder/${user.id}`);
